...
public class Admin {
    ...
    public static void main(String[] args) {
        ...
        String answer;
        do {
            System.out.println("Select change you want to do: ");
            System.out.println("(1) Add");
            System.out.println("(2) Update");
            System.out.println("(3) Remove");
            System.out.println("(4) Display");
            System.out.println("(5) Save to File");
            System.out.println("(6) Clear All Data from File");
            ...
            switch (num) {
                case 1:
                    ...
                    break;
                case 2:
                    admin.Update_restaurants();
                    break;
                case 3:
                    admin.Remove_Resturant();
                    break;
                case 4:
                    admin.displayRestaurants();
                    break;
                case 5:
                    admin.saveRestaurantsToFile();
                    break;
                case 6:
                    admin.clearDataFromFile();
                    break;
                case 7:
            ...
            System.out.println("Do you want to do more updates? (Y/N) ");
            answer = input.next();
